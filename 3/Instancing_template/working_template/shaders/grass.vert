...
void main() {
    ...
    vec4 var = vec4(variance.x * scales.y, variance.y - 0.02 * point.y , variance.z, variance.w);


	gl_Position = camera * (positionMatrix * rotation * scaleMatrix * point + var * point.y * point.y / 2.0);
